...
public class OpenShiftDeleterJsonYaml extends OpenShiftBaseStep implements
        IOpenShiftDeleterJsonYaml {
    ...
    @DataBoundConstructor
    public OpenShiftDeleterJsonYaml(String apiURL, String namespace,
            String authToken, String verbose, String jsonyaml) {
    ...
    /**
     * Descriptor for {@link OpenShiftDeleterJsonYaml}. Used as a singleton. The
