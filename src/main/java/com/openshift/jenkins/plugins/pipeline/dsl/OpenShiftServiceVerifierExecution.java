...
public class OpenShiftServiceVerifierExecution extends AbstractSynchronousNonBlockingStepExecution<Void> {
    ...
    @Inject
    private transient OpenShiftServiceVerifier step;
