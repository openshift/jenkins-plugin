...
public class OpenShiftDeploymentVerifierExecution extends AbstractSynchronousNonBlockingStepExecution<Void> {
    ...
    @Inject
    private transient OpenShiftDeploymentVerifier step;
