...
public class OpenShiftDeleterJsonYamlExecution extends AbstractSynchronousNonBlockingStepExecution<Void> {
    ...
    @Inject
    private transient OpenShiftDeleterJsonYaml step;
