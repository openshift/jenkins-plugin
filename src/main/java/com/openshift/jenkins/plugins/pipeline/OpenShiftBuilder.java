...
public class OpenShiftBuilder extends OpenShiftBaseStep implements IOpenShiftBuilder {
	...
	public OpenShiftBuilder(String apiURL, String bldCfg, String namespace, String authToken, String verbose, String commitID, String buildName, String showBuildLogs, String checkForTriggeredDeployments, String waitTime, String waitUnit) {
	 ...
	 *
	 */
	// NOTE: The getters in this class are used to populate the values of global.jelly, and the fields must match the
	// method names
	...
	public static final class DescriptorImpl extends BuildStepDescriptor<Builder> implements IOpenShiftTimedStepDescriptor {
		...
		public DescriptorImpl() {
			...
			doFillWaitUnit(GlobalConfig.getBuildWaitUnits());
			doFillWait(GlobalConfig.getBuildWait());
		}
		...
		public boolean configure(StaplerRequest req, JSONObject formData) throws FormException {
			// To persist global configuration information, pull info from formData, set appropriate instance field
			// (which should have a getter), and call save().  This method is called when a user presses "Apply" or
			// "Save"
			wait = formData.getString("wait");
			waitUnit = formData.getString("waitUnit");

			GlobalConfig.setBuildWait(wait + waitUnit);
			save();
