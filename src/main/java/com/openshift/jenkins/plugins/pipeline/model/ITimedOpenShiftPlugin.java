...
public interface ITimedOpenShiftPlugin extends IOpenShiftPlugin {
    ...
    default long getTimeout(TaskListener listener, boolean chatty, Map<String, String> overrides) {
        long global = getGlobalTimeoutConfiguration();

        /**
         * We allow user to specify variable names for
         * timeout values, so check overrides map.
         */
        ...
        if ( chatty ) {
            ...
            if ( field == null || field.trim().isEmpty() ) {
                ...
                listener.getLogger().println( "Local step timeout configuration: " + field + " " + unit );
            }
        }
