...
public class OpenShiftScaler extends TimedOpenShiftBaseStep implements
    ...
    @DataBoundConstructor
    public OpenShiftScaler(String apiURL, String depCfg, String namespace,
            String replicaCount, String authToken, String verbose,
            String verifyReplicaCount, String waitTime, String waitUnit) {
    ...
    /**
     * Descriptor for {@link OpenShiftScaler}. Used as a singleton. The class is
