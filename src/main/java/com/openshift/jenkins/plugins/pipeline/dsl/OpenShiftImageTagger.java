...
public class OpenShiftImageTagger extends OpenShiftBaseStep implements
    ...
    // started the process with this class of moving from testTag/Stream to
    // srcTag/Stream and from prodTag/Stream to destTag/Stream
    ...
    @DataBoundConstructor
    public OpenShiftImageTagger(String srcStream, String srcTag,
            String destStream, String destTag) {
    ...
    public void setDestinationAuthToken(String destinationAuthToken) {
        this.destinationAuthToken = destinationNamespace != null ? destinationAuthToken
                .trim() : null;
    }
