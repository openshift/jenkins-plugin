...
public class OpenShiftBuildCanceller extends OpenShiftBasePostAction {
    ...
    @DataBoundConstructor
    public OpenShiftBuildCanceller(String apiURL, String namespace,
            String authToken, String verbose, String bldCfg) {
    ...
    /**
     * Descriptor for {@link OpenShiftBuildCanceller}. Used as a singleton. The
