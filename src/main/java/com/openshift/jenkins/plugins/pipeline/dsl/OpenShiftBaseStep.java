...
public abstract class OpenShiftBaseStep extends AbstractStepImpl implements
    ...
    /*
     * @Override public TokenAuthorizationStrategy getToken() { return
     * bearerToken; }
     * 
     * @Override public void setToken(TokenAuthorizationStrategy token) {
