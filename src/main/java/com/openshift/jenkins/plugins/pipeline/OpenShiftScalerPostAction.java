...
public class OpenShiftScalerPostAction extends OpenShiftBasePostAction implements IOpenShiftScaler {
	...
	public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> implements IOpenShiftTimedStepDescriptor {
		private String wait;
		...
		public DescriptorImpl() {
			...
			doFillWaitUnit(GlobalConfig.getScalerWaitUnits());
			doFillWait(GlobalConfig.getScalerWait());
		}
		...
		public boolean configure(StaplerRequest req, JSONObject formData) throws FormException {
			...
			GlobalConfig.setScalerWait(wait + waitUnit);
			save();
